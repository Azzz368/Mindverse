...
export function TopBar() {
  ...
  return (
    <header className="flex h-14 items-center gap-3 border-b border-[#e7eaf0] bg-white px-4 dark:border-slate-800 dark:bg-[#0c1622]">
      <Link href="/" className="text-sm font-bold tracking-tight text-[#030303] dark:text-cyan-300">
        MINDVERSE
      </Link>
      <Link href="/workspace" className="mr-2 rounded-md px-2 py-1 text-xs font-semibold text-[#59616d] transition hover:bg-[#f0f1f3] hover:text-[#030303] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white">
        ← Workspace
      </Link>
      <Input
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Button onClick={createSkill}>{t.saveAsSkill}</Button>
