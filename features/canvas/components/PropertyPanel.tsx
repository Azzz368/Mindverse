...
function buildFields(t: Strings): Record<string, Field[]> {
  return {
    ...
    image: [{ key: "title", label: t.fieldTitle }, { key: "prompt", label: t.fieldImagePrompt, kind: "textarea" }, { key: "model", label: t.fieldModelNote, kind: "select", options: ["gpt-image-2", "gpt-image-2(tokenstar)", "nano banana(tokenstar)", "gemini-3.1-flash-image-preview"] }, { key: "size", label: t.fieldSize, kind: "select", options: ["1024x1024", "1536x1024", "1024x1536", "2048x2048", "auto"] }],
    ...
    videoEdit: [{ key: "title", label: t.fieldTitle }, { key: "editPlan", label: "Edit plan JSON", kind: "textarea" }, { key: "prompt", label: "Notes", kind: "textarea" }, { key: "preserveAudio", label: "Preserve audio", kind: "select", options: ["true", "false"] }, { key: "resolution", label: t.fieldResolution, kind: "select", options: ["480p", "720p", "1080p"] }, { key: "fps", label: t.fieldFps }, { key: "aspectRatio", label: t.fieldAspectRatio, kind: "select", options: ["16:9", "9:16", "1:1"] }],
