...
export const workflowColumnByType: Record<NodeType, number> = { prompt: 0, text: 1, script: 1, storyboard: 2, storyboardImage: 3, image: 4, reference: 4, video: 5, audio: 5, voiceClone: 5, voiceTTS: 6, videoFrame: 6, videoEdit: 7, motion: 8, output: 9 };
