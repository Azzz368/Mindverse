...
export async function runCanvasNode(node: CanvasNode, inputs: unknown[] = []): Promise<NodeOutput> {
  ...
  switch (d.nodeType) {
    ...
    case "videoEdit": return output("videoEdit", "Video edit plan prepared", { editPlan: d.editPlan, preserveAudio: d.preserveAudio !== false, resolution: d.resolution, fps: d.fps, aspectRatio: d.aspectRatio });
