...
export type CanvasNodeData = {
  ...
  model?: string; size?: string; referenceImageUrl?: string; imageReferenceNodeIds?: string[]; imageHistory?: string[]; activeImageUrl?: string; imageGenerationMode?: "generation" | "specialized"; imagePromptPreset?: "character-turnaround" | "scene-nine-grid" | "scene-top-view"; temperature?: number;
  ...
  musicName?: string; musicTags?: string; ttsMode?: "quick" | "advanced"; ttsInstructions?: string; xVectorOnly?: boolean;
  ...
  editPlan?: string; videoEditMode?: "quick" | "ai-creative"; preserveAudio?: boolean; originalVolume?: number; backgroundVolume?: number; fadeIn?: number; fadeOut?: number; transition?: "none" | "fade";
  compositionJson?: string; motionComposition?: MotionComposition; templateId?: string; motionVariablesJson?: string; motionMode?: "template" | "codex-hyperframes"; codexInstruction?: string; hyperframesProjectId?: string; hyperframesProjectDir?: string;
  videoGenerationMode?: "general" | "digital-human"; videoModelPreset?: VideoModelPresetId; videoProvider?: "mock" | "302ai" | "302-sora2" | "tokenstar" | "kling" | "hkgai" | "volcengine" | "talkingdata"; tokenstarMode?: "text-to-video" | "asset-video" | "kling-image" | "kling-text" | "kling-omni"; generateAudio?: boolean; referenceImageAssetUrl?: string; referenceVideoAssetUrl?: string; referenceAudioAssetUrl?: string; klingMode?: "text-to-video" | "image-to-video" | "reference-image" | "omni"; klingElementId?: string; referenceVideoUrl?: string; talkingDataImageMode?: "first-frame" | "first-last-frame" | "reference"; talkingDataEndImageUrl?: string; talkingDataOmniReferenceTaskType?: "auto" | "reference" | "edit" | "extend"; talkingDataOutputFormat?: "mp4" | "mov"; talkingDataWatermark?: boolean; talkingDataReturnLastFrame?: boolean; talkingDataWebSearch?: boolean; /** Ordered connected image/video/audio references; their order defines @1, @2, ... in the VideoNode prompt. */ videoReferenceNodeIds?: string[]; /** True once the user explicitly changes the VideoNode reference selection. */ videoReferenceSelectionActive?: boolean; taskId?: string; resultUrl?: string; rawStatus?: string; lastPollAt?: string;
