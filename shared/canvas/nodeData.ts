...
export type CanvasNodeData = {
  ...
  videoModelPreset?: VideoModelPresetId; videoProvider?: "mock" | "302ai" | "302-sora2" | "tokenstar" | "kling" | "hkgai" | "volcengine"; tokenstarMode?: "text-to-video" | "asset-video" | "kling-image" | "kling-text" | "kling-omni"; generateAudio?: boolean; referenceImageAssetUrl?: string; referenceVideoAssetUrl?: string; referenceAudioAssetUrl?: string; klingMode?: "text-to-video" | "image-to-video" | "reference-image" | "omni"; klingElementId?: string; referenceVideoUrl?: string; /** Ordered connected image/video/audio references; their order defines @1, @2, ... in the VideoNode prompt. */ videoReferenceNodeIds?: string[]; /** True once the user explicitly changes the VideoNode reference selection. */ videoReferenceSelectionActive?: boolean; taskId?: string; resultUrl?: string; rawStatus?: string; lastPollAt?: string;
